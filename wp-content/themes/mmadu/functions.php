...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('site_scripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.0'); // Custom scripts
...
{
    wp_register_style('grid', get_template_directory_uri() . '/css/bootstrap-grid.min.css', array(), '1.0', 'all');
    wp_enqueue_style('grid'); // Enqueue it!

    wp_register_style('site_style', get_template_directory_uri() . '/css/app.css', array(), '1.0', 'all');
    wp_enqueue_style('site_style'); // Enqueue it!
}
...
add_action( 'init', 'disable_wp_emojicons' ); //Disable emojicons
...
function custom_post_type_events() {
	...
	$args = array(
		...
		'description'           => __( 'A collection of our events', 'text_domain' ),
		'labels'                => $labels,
